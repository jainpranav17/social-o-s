          ...
          return (
            ...
            >
              ...
              >
                ...
                {platform.comingSoon ? (
                  <span className="rounded-full bg-amber-500/20 text-amber-200 px-3 py-1 text-xs font-semibold backdrop-blur-sm">
                    Coming Soon
                  </span>
                ) : isConnected ? (
              ...
              <div className="flex flex-1 flex-col justify-between p-6">
                <div className="mb-6 space-y-2">
                  ...
                  {isConnected ? (
                    ...
                    <p className="text-xs text-muted-foreground leading-relaxed">
                      {platform.name} integration is currently under development and will be available in an upcoming update.
                    </p>
                  ) : (
                    <p className="text-xs text-muted-foreground leading-relaxed">
                ...
                {isConnected ? (
                  ...
                  <button
                    disabled
                    className="flex w-full items-center justify-center gap-2 rounded-xl border border-border/50 bg-muted/30 px-4 py-2.5 text-sm font-semibold text-muted-foreground/60 cursor-not-allowed opacity-70"
                  >
                    Coming Soon
                  </button>
                ) : (
